...
export function CloudStudyWorkspace() {
  ...
  useEffect(() => {
    if (typeof window === "undefined" || document.getElementById("google-gsi-script")) return;
  ...
  const initGoogleAuth = useCallback(() => {
    const googleClientId = process.env.NEXT_PUBLIC_GOOGLE_CLIENT_ID || "527944201212-p6u14qeocj5sfmqk633v2fott18uog8v.apps.googleusercontent.com";
  ...
  return <main className="study-shell">
    <header className="study-nav">
      ...
      <div className="nav-actions">
        <a className="text-button landing-link" href="/">← Home</a>
